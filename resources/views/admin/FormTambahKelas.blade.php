      ...
      <div class="col-9">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Tambah kelas</li>
          </ol>
        </nav>
      </div>
      <div class="col-3">
...
<form action="{{ route('buatKelasStore') }}" method="POST">
  @csrf
  <div class="row">
    ...
    <div>
      <button type="submit" class="mt-4 btn btn-rounded btn-success text-black">Simpan Kelas</button>
    </div>
  </div>
</form>
